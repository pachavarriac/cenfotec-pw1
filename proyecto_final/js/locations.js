window.onload = function () {
  ...
  function mostrarUbicacion(valor) {
    provincia.innerHTML = `<img src="images/provinces/${valor}.jpg" style="height: 344px; width: 296px; margin: 0px 30px; border-radius: 10px; box-shadow: 0px 0px 15px 7px rgba(210,210,210,0.75);" alt="" />`;
